    ...
    return (
        <div className="w-screen flex justify-center items-center h-screen">
            <div className="flex flex-col justify-center items-center max-w-sm p-10 bg-white border border-gray-200 rounded-lg shadow ">
                ...
                <Link href={"/dashboard"}>
                    <button 
                        type="button" className="mt-5 w-60 text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">
                        Dashboard
                    </button>
                </Link>
            </div>
